...
**To run the analysis yourself, you must also remove the `eval=FALSE` option from the R code chunk headers in the following sections.**
...
cif_root_dir <- "path/to/your/clathrate_data_folder"
